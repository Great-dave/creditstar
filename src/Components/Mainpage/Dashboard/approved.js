    ...
    <div className="row row-cols-1 row-cols-md-2 g-3 m-auto">
          ...
          <div className="row my-4">
           <div className="col-6 px-3">
            <a className="nav-link fw-bold fs-6 card-request" href="/">
             <i className="far fa-credit-card mb-3 ms-1 pe-2"></i>
       Card Request
        </a>
           </div>
          </div>
            ...
            <a className="nav-link prediction px-3 fs-6" href="/">
             <div className="dropdown">
              ...
              <ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownMenuButton2">
               <li><a className="dropdown-item approved-flag" href="/">Approved</a></li>
     ...
     <div className="col-md-8 px-">
      <div className="card mb-3">
       <div className="card-body">
        <div className="flag-req mx-4 mt-2 px-3"><Header className="over" header="Approved Request" /></div>
       </div>
      </div>
      ...
      <div className="card mx-4 mt-2 px-4">
       <div className="card-body ">
        <div className="row px-3 mx-4 mt-2">
         ...
         <div className="col px-1 mx-2 cont ">
          <ol className="list-unstyled">
         ...
         <div className="col px-1 mx-2 cont ">
          <ol className="list-unstyled">
           <li className="flagged-li fw-bold">LIMIT: </li>
           <li className="flagged-li fw-bold">9,000,000 </li>
           <li className="flagged-li fw-bold">9,000,000 </li>
           <li className="flagged-li fw-bold">9,000,000 </li>
           <li className="flagged-li fw-bold">9,000,000 </li>
           <li className="flagged-li fw-bold">9,000,000 </li>
         ...
         <div className="col px-1 mx-2 cont ">
          <ol className="list-unstyled">
           ...
           <li className="flagged-li fw-bold text-info">ACTIONS<i className="fas fa-chevron-down ms-1 ps-1"></i></li>
           <li className="flagged-li fw-bold text-info">ACTIONS<i className="fas fa-chevron-down ms-1 ps-1"></i></li>
           <li className="flagged-li fw-bold text-info">ACTIONS<i className="fas fa-chevron-down ms-1 ps-1"></i></li>
           <li className="flagged-li fw-bold text-info">ACTIONS<i className="fas fa-chevron-down ms-1 ps-1"></i></li>
           <li className="flagged-li fw-bold text-info">ACTIONS<i className="fas fa-chevron-down ms-1 ps-1"></i></li>
