     ...
     <div className="card mb-3">
      <div className="card-body">
       <div className="flag-req mx-4 mt-2 px-3">
        <h5 className='h5-message py-3 px-3'>
       ...
       <div className="flag-req mx-4 mt-2 px-3">
        <form className="d-flex">
         <label className="col-sm-12">
          <input className="form-control msg my-3 me-2" type="Email" placeholder="Email" aria-label="Email" />
          <input className="form-control my-3 pe-4 me-2" type="text" placeholder="Subject" aria-label="text" />

          <textarea name="" id="" className="pe-5 col-sm-12" rows="5" placeholder="Kindly tell us what the bottleneck is and what we can do to serve you better, our team will work on it"></textarea>
         </label>
        </form>
        <a className="nav-link px-5 ms-5" href="/">
         <button className="my-2 ms-5 send-message">Send</button>
        </a>
       </div>
      </div>
     </div>
